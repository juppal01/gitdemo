...
function searchAndPrintLine($filePath, $searchWord){
	...
	if (!$found) {
		...
		$qry="SELECT a.SERIAL_NUMBER,a.FTreportPath FROM mes_testing a left join mes_sno_master b on a.SERIAL_NUMBER = b.sno  where b.ponumber in ('SI2AC7212002X','SI2AC7230006X','ZZZ0002222')";
