...
function searchAndPrintLine($filePath, $searchWord){
	...
	if (!$found) {
		...
		$qry="SELECT a.SERIAL_NUMBER, a.HPreportPath FROM mes_testing a LEFT JOIN mes_sno_master b ON a.SERIAL_NUMBER = b.sno WHERE b.ponumber IN ('SI2AC7212002X', 'SI2AC7230006X', 'ZZZ0002222') and trim(a.HPReportPath) != '';";
		...
		//	$filePathHP  = $recSet["HPreportPath"];
			...
			$i=0;
			$qry="Insert into mes_ft_test_result_extract_FDL(SNo,TPV,TDST,PN,Line,Test_PC,TP_IP,
